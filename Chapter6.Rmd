...
obsAll.df <- read.table(paste0(obsData, "FallDtreatment.txt"),
                   header = TRUE)
...
mergedf<-merge(obsfd,simD,by=c("Clock.Today","Name","Variable"))
summary(mergedf)
str(mergedf)
mergedf
...
ggplot(aes(x=Clock.Today,y=Predicted))+geom_line(size=1)+theme_bw()+
  ...
  geom_point(data=obsfd2LAI1, aes(x=Clock.Today1, y=Observed),colour="green",size=3)+
...
ggplot(aes(x=Clock.Today,y=Predicted))+geom_line(size=1)+theme_bw()+
  facet_wrap(~ID,ncol = 1)+
  geom_point(data=obsfd10LAI1, aes(x=Clock.Today1, y=Observed),colour="green",size=3)+
  theme(legend.title=element_blank(),legend.position = "blank")+xlab("Date")+ylab(bquote(bold('LAI ('*m^2~m^-2*')')))+
  mytheme3
...
ggplot(aes(x=Clock.Today,y=Predicted))+geom_line(size=1)+theme_bw()+
  facet_wrap(~ID,ncol = 1)+
  geom_point(data=obsfd2LAI2, aes(x=Clock.Today1, y=Observed),colour="green",size=3)+
  theme(legend.title=element_blank(),legend.position = "blank")+xlab("Date")+ylab(bquote(bold('LAI ('*m^2~m^-2*')')))+
  mytheme3
...
ggplot(aes(x=Clock.Today,y=Predicted))+geom_line(size=1)+theme_bw()+
  facet_wrap(~ID,ncol = 1)+
  geom_point(data=obsfd10LAI2, aes(x=Clock.Today1, y=Observed),colour="green",size=3)+
  theme(legend.title=element_blank(),legend.position = "blank")+xlab("Date")+ylab(bquote(bold('LAI ('*m^2~m^-2*')')))+
  mytheme3
...
ggplot(aes(x=Clock.Today,y=Predicted))+geom_line(size=1)+theme_bw()+
  facet_wrap(~ID,ncol = 1)+
  geom_point(data=obsfd2LAI, aes(x=Clock.Today1, y=Observed),colour="green",size=3)+
  theme(legend.title=element_blank(),legend.position = "blank")+xlab("Date")+ylab(bquote(bold('LAI ('*m^2~m^-2*')')))+
  mytheme3
...
ggplot(aes(x=Clock.Today,y=Predicted))+geom_line(size=1)+theme_bw()+
  facet_wrap(~ID,ncol = 1)+
  geom_point(data=obsfd10LAI, aes(x=Clock.Today1, y=Observed),colour="green",size=3)+
  theme(legend.title=element_blank(),legend.position = "blank")+xlab("Date")+ylab(bquote(bold('LAI ('*m^2~m^-2*')')))+
  mytheme3
...
ggplot(aes(x=Clock.Today,y=Predicted))+geom_line(size=1)+theme_bw()+
  facet_wrap(~ID,ncol = 1)+
  geom_point(data=obsYield6, aes(x=Clock.Today1, y=Observed),colour="green",size=3)+
  theme(legend.title=element_blank(),legend.position = "blank")+xlab("Date")+ylab(bquote(bold('Shoot DM ('*kg~ha^-1*')')))+
  mytheme3
  #annotate("text", x=ymd_hms("2016-07-24 12:00:00"), y=8500, size = 5, label ="paste(R_RMSD == 77.4,'%')" , parse=T)
 #geom_text(aes(x=ymd_hms("2016-07-24 12:00:00"), y=920,label="R_RMSD = 40%",size=5))
...
simD5%>%
ggplot(aes(x=Clock.Today,y=Predicted))+geom_line(size=1)+theme_bw()+
  facet_grid(~ID)+ggtitle(paste0("E5IHHFD2","(Iversen_121DefoliationHHFDFD2)"))+
...
simD6%>%
ggplot(aes(x=Clock.Today,y=Predicted))+geom_line(size=1)+theme_bw()+
  facet_grid(~ID)+ggtitle(paste0("E5IHHFD10","(Iversen_121DefoliationHHFDFD10)"))+
...
simD7$Variable<- factor(simD7$Variable, levels=c("shootbiomass","RootWt"))
str(simD7)
simD7%>%
ggplot(aes(x=Clock.Today,y=Predicted))+geom_line(size=1)+theme_bw()+
  facet_grid(~ID)+ggtitle(paste0("E5ILLFD10","(Iversen_121DefoliationLLFDFD10)"))+
  geom_point(data=ObsR7, aes(x=Clock.Today1, y=Observed),colour="green",size=3)+
  theme(legend.title=element_blank(),legend.position = "blank")+xlab("Date")+ylab("Root biomass(kg/ha)")+
 #remove grid lines 
   theme(
     panel.spacing=unit(.01, "lines"),
...
simD8$Variable<- factor(simD8$Variable, levels=c("shootbiomass","RootWt"))
str(simD8)
simD8%>%
ggplot(aes(x=Clock.Today,y=Predicted))+geom_line(size=1)+theme_bw()+
  facet_grid(~ID)+ggtitle(paste0("E5ILLFD10","(Iversen_121DefoliationLLFDFD10)"))+
  geom_point(data=ObsR8, aes(x=Clock.Today1, y=Observed),colour="green",size=3)+
  theme(legend.title=element_blank(),legend.position = "blank")+xlab("Date")+ylab("Root biomass(kg/ha)")+
 #remove grid lines 
   theme(
     panel.spacing=unit(.01, "lines"),
...
simD9$Variable<- factor(simD9$Variable, levels=c("shootbiomass","RootWt"))
str(simD9)
simD9%>%
ggplot(aes(x=Clock.Today,y=Predicted))+geom_line(size=1)+theme_bw()+
  facet_grid(~ID)+ggtitle(paste0("E5ISSFD2","(Iversen_121DefoliationSSFDFD2)"))+
  geom_point(data=ObsR9, aes(x=Clock.Today1, y=Observed),colour="green",size=3)+
  theme(legend.title=element_blank(),legend.position = "blank")+xlab("Date")+ylab("Root biomass(kg/ha)")+
 #remove grid lines 
   theme(
     panel.spacing=unit(.01, "lines"),
...
simD10$Variable<- factor(simD9$Variable, levels=c("shootbiomass","RootWt"))
str(simD10)
simD9%>%
ggplot(aes(x=Clock.Today,y=Predicted))+geom_line(size=1)+theme_bw()+
  facet_grid(~ID)+ggtitle(paste0("E5ISSFD10","(Iversen_121DefoliationSSFDFD10)"))+
  geom_point(data=ObsR10, aes(x=Clock.Today1, y=Observed),colour="green",size=3)+
  theme(legend.title=element_blank(),legend.position = "blank")+xlab("Date")+ylab("Root biomass(kg/ha)")+
 #remove grid lines 
   theme(
     panel.spacing=unit(.01, "lines"),
