...
PhyPp%>%
 ...
 ggsave("D:/R/Pictures/Node/phyll.png", width=8, height=5, dpi=500)
   detach(package:plyr)
```
...
obsNode1<-obsA%>%
 ...
 theme(legend.title=element_blank(),legend.position = "blank")+xlab("Date")+ylab("Node number")+
  ...
  theme(
     ...
     legend.title = element_text(colour="black", size=14, face="bold"),
     axis.text = element_text(face = "bold", vjust = 0.5, size = 14))+
   annotate("text", x=ymd_hms("1999-10-24 12:00:00"), y=17, size = 5, label ="paste(R_RMSD == 21.9,'%')", parse=T)
...
ggplot(aes(x=Clock.Today,y=Predicted))+geom_line(size=1)+theme_bw()+
  ...
  theme(
     ...
     legend.title = element_text(colour="black", size=14, face="bold"),
     axis.text = element_text(face = "bold", vjust = 0.5, size = 14))+
  annotate("text", x=ymd_hms("2003-07-24 12:00:00"), y=17, size = 5, label ="paste(R_RMSD == 21.7,'%')", parse=T)
...
dat_text1 <- data.frame(
  label = c("R_RMSE=27.5%", "R_RMSE=27.9%", "R_RMSE=21.9%","R_RMSE=24.4%"),
...
ggplot(aes(x=Clock.Today,y=Predicted))+geom_line(size=1)+theme_bw()+
  ...
  #remove grid lines 
   theme(
     ...
     legend.title = element_text(colour="black", size=14, face="bold"),
     axis.text = element_text(face = "bold", vjust = 0.5, size = 14))+
   annotate("text", x=ymd_hms("2016-07-24 12:00:00"), y=18, size = 5, label ="paste(R_RMSD == 29.7,'%')", parse=T)
