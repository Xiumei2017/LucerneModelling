...
my.formula  <- function(HchronPpE5){
...
my.eqsE5 <- ddply(HchronPpE5,.(Stage),my.formula)
...
b<-HchronPpE5%>%
  ...
  facet_grid(~FD)+mytheme3+theme(legend.title = element_blank())

b+geom_text(data = my.eqsE5, aes(x = 13.7, y = 6, label = V1), 
