...
obsYield%>%
  ...
  ggplot(aes(x=Tt_broken_sum, y=Observed))+geom_point(size=2)+theme_bw()+xlab("Thermal time (°Cd) ")+ylab("Shoot DM (kg DM/ha)"   )+ggtitle("Iversen_8Waterirr")  +
...
RUEshoot1%>%  
  ggplot(aes(x=PARi.sum, y=Shootbiomass))+geom_point(size=2)+theme_bw()+xlab("Accumulated PARi (MJ/m^2)")+ylab("Shoot DM (g DM/m^2)"   )+ggtitle("Iversen_8Waterirr")  +
 geom_smooth(method = "lm", se = TRUE, linetype = 1, colour="blue")+
 facet_grid(GrowthSeason.x~Rotation.x)+
  theme(axis.title.x=element_text(face="bold",colour="black",size = 12))+
 theme(axis.title.y=element_text(face="bold",colour="black",size = 12))
...
RUEshoot2<-RUEshoot %>%
  ...
  mutate(Shootbiomass=Shootbiomass*0.001)
RUEshoot2%>%
  ggplot(aes(x=PARi.sum, y=Shootbiomass))+geom_point(size=2)+theme_bw()+xlab("Accumulated PARi (MJ/m^2)")+ylab("Shoot DM (g DM/m^2)"   )+ggtitle("Iversen_91DefoliationLL")  +
 geom_smooth(method = "lm", se = TRUE, linetype = 1, colour="blue")+
 facet_grid(GrowthSeason.x~Rotation.x)+
  theme(axis.title.x=element_text(face="bold",colour="black",size = 12))+
 theme(axis.title.y=element_text(face="bold",colour="black",size = 12))
jpeg("RUEshoot2", width=1000, height=1000, units="px", pointsize=20, quality=100)
```
...
RUEshoot3%>%
  ggplot(aes(x=PARi.sum, y=Shootbiomass))+geom_point(size=2)+theme_bw()+xlab("Accumulated PARi (MJ/m^2)")+ylab("Shoot DM (g DM/m^2)"   )+ggtitle("Iversen_9SowingDateSD1Waterirr")  +
 geom_smooth(method = "lm", se = TRUE, linetype = 1, colour="blue")+
 facet_grid(GrowthSeason.x~Rotation.x)+
  theme(axis.title.x=element_text(face="bold",colour="black",size = 12))+
 theme(axis.title.y=element_text(face="bold",colour="black",size = 12))
...
RUEshoot4<-RUEshoot %>%
  ...
  dplyr::filter(Name=="Iversen_9SowingDateSD2Waterirr")%>%
   mutate(Shootbiomass=Shootbiomass*0.001)
RUEshoot4%>%
  ggplot(aes(x=PARi.sum, y=Shootbiomass))+geom_point(size=2)+theme_bw()+xlab("Accumulated PARi (MJ/m^2)")+ylab("Shoot DM (g DM/m^2)"   )+ggtitle("Iversen_9SowingDateSD2Waterirr")  +
 geom_smooth(method = "lm", se = TRUE, linetype = 1, colour="blue")+
 facet_grid(GrowthSeason.x~Rotation.x)+
  theme(axis.title.x=element_text(face="bold",colour="black",size = 12))+
 theme(axis.title.y=element_text(face="bold",colour="black",size = 12))
...
RUEshoot5<-RUEshoot %>%
  ...
  dplyr::filter(Name=="Iversen_9SowingDateSD3Waterirr")%>%
   mutate(Shootbiomass=Shootbiomass*0.001)
RUEshoot5%>%
  ggplot(aes(x=PARi.sum, y=Shootbiomass))+geom_point(size=2)+theme_bw()+xlab("Accumulated PARi (MJ/m^2)")+ylab("Shoot DM (g DM/m^2)"   )+ggtitle("Iversen_9SowingDateSD3Waterirr")  +
 geom_smooth(method = "lm", se = TRUE, linetype = 1, colour="blue")+
 facet_grid(GrowthSeason.x~Rotation.x)+
  theme(axis.title.x=element_text(face="bold",colour="black",size = 12))+
 theme(axis.title.y=element_text(face="bold",colour="black",size = 12))
...
RUEshoot6<-RUEshoot %>%
  ...
  dplyr::filter(Name=="Iversen_9SowingDateSD4Waterirr")%>%
   mutate(Shootbiomass=Shootbiomass*0.001)
RUEshoot6%>%
  ggplot(aes(x=PARi.sum, y=Shootbiomass))+geom_point(size=2)+theme_bw()+xlab("Accumulated PARi (MJ/m^2)")+ylab("Shoot DM (g DM/m^2)"   )+ggtitle("Iversen_9SowingDateSD4Waterirr")  +
 geom_smooth(method = "lm", se = TRUE, linetype = 1, colour="blue")+
 facet_grid(GrowthSeason.x~Rotation.x)+
  theme(axis.title.x=element_text(face="bold",colour="black",size = 12))+
 theme(axis.title.y=element_text(face="bold",colour="black",size = 12))
...
RUEshoot7<-RUEshoot %>%
  ...
  dplyr::filter(Name=="Iversen_121DefoliationLLFDFD5")%>%
   mutate(Shootbiomass=Shootbiomass*0.001)
RUEshoot7%>%
  ggplot(aes(x=PARi.sum, y=Shootbiomass))+geom_point(size=2)+theme_bw()+xlab("Accumulated PARi (MJ/m^2)")+ylab("Shoot DM (g DM/m^2)"   )+ggtitle("Iversen_121DefoliationLLFDFD5")  +
 geom_smooth(method = "lm", se = TRUE, linetype = 1, colour="blue")+
 facet_grid(GrowthSeason.x~Rotation.x)+
  theme(axis.title.x=element_text(face="bold",colour="black",size = 12))+
 theme(axis.title.y=element_text(face="bold",colour="black",size = 12))
...
RUE.RAW%>%
  ...
  ggplot(aes(x=PARi.sum, y=Biomass))+geom_point(size=2)+theme_bw()+xlab("Accumulated PARi (MJ/m^2)")+ylab("Total DM (g DM/m^2)"   )+ggtitle("Iversen_91DefoliationLL")  +
 geom_smooth(method = "lm", se = TRUE, linetype = 1, colour="blue")+
 facet_grid(GrowthSeason.x~Rotation.x)+
  theme(axis.title.x=element_text(face="bold",colour="black",size = 12))+
 theme(axis.title.y=element_text(face="bold",colour="black",size = 12))
...
RUE.RAW%>%
  ...
  dplyr::filter(Name=="Iversen_121DefoliationLLFDFD5")%>%
  mutate(Biomass=Biomass*0.001)%>%
  ggplot(aes(x=PARi.sum, y=Biomass))+geom_point(size=2)+theme_bw()+xlab("Accumulated PARi (MJ/m^2)")+ylab("Total DM (g DM/m^2)"   )+ggtitle("Iversen_121DefoliationLLFDFD5")  +
 geom_smooth(method = "lm", se = TRUE, linetype = 1, colour="blue")+
 facet_grid(GrowthSeason.x~Rotation.x)+
  theme(axis.title.x=element_text(face="bold",colour="black",size = 12))+
 theme(axis.title.y=element_text(face="bold",colour="black",size = 12))
...
RUETotal%>%
  ...
  filter(RUEt1>0)%>%
  ggplot(aes(x=Tmean,y=RUEt1,color=Name))+geom_point()+
  geom_line(data=df,aes(x=a, y=b),color="red")+
  theme(axis.title.x=element_text(face="bold",colour="black",size = 12))+
 theme(axis.title.y=element_text(face="bold",colour="black",size = 12))+
  facet_grid(~Stage)+xlab("Mean temperature (°Cd)")+ylab("Total RUE (g DM/MJ)")+
  theme_bw()+
  theme(axis.title.x=element_text(face="bold",colour="black",size = 12))+
 theme(axis.title.y=element_text(face="bold",colour="black",size = 12))+
   geom_smooth(method = "lm", se = TRUE, linetype = 1, colour="blue")
...
obsTotalO<-obsTotal%>%
  ...
  dplyr::select(Clock.Today,Name,Collection,GrowthSeason.x,Rotation.x,Ppm,Tmean,Time,VariableUnits,shootbiomass,RootWt,TotalDM)%>%
...
obsYield1<-obsYield%>%
 ...
 theme(legend.title=element_blank(),legend.position = "blank")+xlab("Date")+ylab("Shoot DM (kg DM/ha)")+
 theme(axis.title.x=element_text(face="bold",colour="black",size = 12))+
 theme(axis.title.y=element_text(face="bold",colour="black",size = 12))
...
```
###join to table together for root data
```{r}
RM<-mergedf %>%
  dplyr::filter(Variable== "RootWt") %>% 
   dplyr::filter(Water.x== "irr")%>%
  dplyr::filter(Defoliation.x== "LL")%>%
  dplyr::filter(Tb=="1")%>%
  mutate(RM=Predicted-Observed)%>%
  dplyr::select(Clock.Today,Name,GrowthRotation,RM,Predicted)
...
###Root respiration
##load soil temperture data
###Root Respriation analysis
```{r}
...
Rm<-merge(ObsRoot.new,Tsoil,by=c("Clock.Today")) %>%
  #dplyr::filter(Collection!="2010_2012")%>%
  mutate(Rm=(0.015*1.8*exp((Tearth-20)/10)*Observed))%>%
