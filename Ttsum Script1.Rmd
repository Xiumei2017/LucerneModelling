...
metTT1 <- metData %>%
  ...
  rowwise() %>%
  mutate(TTday1=TTfunc(mint,maxt), TTday_s=max(((mint+maxt)/2)-Tb,0), diff=(TTday_s/TTday1)*100)
metTT1
...
metTT2 <- metData %>%
   filter(Clock.Today>"1997-01-01") %>%
  rowwise() %>%
  mutate(TTday2=TTfunc(mint,maxt), TTday_s=max(((mint+maxt)/2)-Tb,0), diff=(TTday_s/TTday2)*100)
metTT2
...
metTT3 <- metData %>%
   filter(Clock.Today>"1997-01-01") %>%
  rowwise() %>%
  mutate(TTday3=TTfunc(mint,maxt), TTday_s=max(((mint+maxt)/2)-Tb,0), diff=(TTday_s/TTday3)*100)
metTT3
...
metTT4 <- metData %>%
   filter(Clock.Today>"1997-01-01") %>%
  rowwise() %>%
  mutate(TTday4=TTfunc(mint,maxt), TTday_s=max(((mint+maxt)/2)-Tb,0), diff=(TTday_s/TTday4)*100)
metTT4
...
metTT5 <- metData %>%
   filter(Clock.Today>"1997-01-01") %>%
  rowwise() %>%
  mutate(TTday5=TTfunc(mint,maxt), TTday_s=max(((mint+maxt)/2)-Tb,0), diff=(TTday_s/TTday5)*100)
metTT5
...
metTT6 <- metData %>%
   filter(Clock.Today>"1997-01-01") %>%
  rowwise() %>%
  mutate(TTday6=TTfunc(mint,maxt), TTday_s=max(((mint+maxt)/2)-Tb,0), diff=(TTday_s/TTday6)*100)
metTT6
...
metTT7 <- metData %>%
   filter(Clock.Today>"1997-01-01") %>%
  rowwise() %>%
  mutate(TTday7=TTfunc(mint,maxt), TTday_s=max(((mint+maxt)/2)-Tb,0), diff=(TTday_s/TTday7)*100)
metTT7
...
metTT8 <- metData %>%
   filter(Clock.Today>"1997-01-01") %>%
  rowwise() %>%
  mutate(TTday8=TTfunc(mint,maxt), TTday_s=max(((mint+maxt)/2)-Tb,0), diff=(TTday_s/TTday8)*100)
metTT8
...
metTT9 <- metData %>%
   filter(Clock.Today>"1997-01-01") %>%
  rowwise() %>%
  mutate(TTday9=TTfunc(mint,maxt), TTday_s=max(((mint+maxt)/2)-Tb,0), diff=(TTday_s/TTday9)*100)
metTT9
...
metTT10 <- metData %>%
   filter(Clock.Today>"1997-01-01") %>%
  rowwise() %>%
  mutate(TTday10=TTfunc(mint,maxt), TTday_s=max(((mint+maxt)/2)-Tb,0), diff=(TTday_s/TTday10)*100)
metTT10
