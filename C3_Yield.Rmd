...
ggplot(aes(x=Clock.Today,y=Observed,color=ID))+geom_line(size=1)+theme_bw()+
 ...
 geom_point(size=2)+
 theme(legend.title=element_blank())+xlab("Date")+ylab("DM yield (kg/ha)")+
    #remove grid lines 
  theme(
     panel.spacing=unit(.01, "lines"),
     panel.border = element_rect(colour = "black",size=1), 
...
simD1%>%
ggplot(aes(x=Clock.Today,y=Predicted))+geom_line(size=1)+theme_bw()+
  facet_grid(Variable~ID)+ggtitle(paste0("E5IHHFD2","(Iversen_121DefoliationHHFDFD2)"))+
  geom_point(data=obsFDHH, aes(x=Clock.Today1, y=Observed),colour="green",size=3)+
  theme(legend.title=element_blank(),legend.position = "blank")+xlab("Date")+ylab("Biomass (kg/ha)")+
  #remove grid lines 
   theme(
   ...
   #annotate("text", x=ymd_hms("2016-07-24 12:00:00"), y=25, size = 5, label ="paste(R_RMSD == 39.7,'%')", parse=T)
   #ggsave("D:/R/Pictures/C5/Node/Iversen_121DefoliationHHFDFD5nodenumber1.png", width=8, height=4, dpi=500)
ggsave("D:/R/Pictures/C5/Yield/Iversen_121DefoliationHHFDFD2yield.png", width=8, height=8, dpi=500)
```
...
simD2%>%
ggplot(aes(x=Clock.Today,y=Predicted))+geom_line(size=1)+theme_bw()+
  facet_grid(Variable~ID)+ggtitle(paste0("E5IHHFD10","(Iversen_121DefoliationHHFDFD10)"))+
  geom_point(data=obsFDHH, aes(x=Clock.Today1, y=Observed),colour="green",size=3)+
  theme(legend.title=element_blank(),legend.position = "blank")+xlab("Date")+ylab("Biomass (kg/ha)")+
  #remove grid lines 
   theme(
   ...
   #annotate("text", x=ymd_hms("2016-07-24 12:00:00"), y=25, size = 5, label ="paste(R_RMSD == 39.7,'%')", parse=T)
   #ggsave("D:/R/Pictures/C5/Node/Iversen_121DefoliationHHFDFD5nodenumber1.png", width=8, height=4, dpi=500)
ggsave("D:/R/Pictures/C5/Yield/Iversen_121DefoliationHHFDFD10yield.png", width=8, height=8, dpi=500)
```
...
simD3%>%
ggplot(aes(x=Clock.Today,y=Predicted))+geom_line(size=1)+theme_bw()+
  facet_grid(Variable~ID)+ggtitle(paste0("E5ILLFD10","(Iversen_121DefoliationLLFDFD10)"))+
  ...
  #remove grid lines 
   ...
   #annotate("text", x=ymd_hms("2016-07-24 12:00:00"), y=25, size = 5, label ="paste(R_RMSD == 39.7,'%')", parse=T)
   #ggsave("D:/R/Pictures/C5/Node/Iversen_121DefoliationHHFDFD5nodenumber1.png", width=8, height=4, dpi=500)
ggsave("D:/R/Pictures/C5/Yield/Iversen_121DefoliationLLFDFD10yield.png", width=8, height=8, dpi=500)
```
##LL
##F2
```{r,  fig.height=4, fig.width=8}
...
simD4%>%
ggplot(aes(x=Clock.Today,y=Predicted))+geom_line(size=1)+theme_bw()+
  facet_grid(Variable~ID)+ggtitle(paste0("E5ILLFD2","(Iversen_121DefoliationLLFDFD2)"))+
  ...
  #remove grid lines 
   ...
   #annotate("text", x=ymd_hms("2016-07-24 12:00:00"), y=25, size = 5, label ="paste(R_RMSD == 39.7,'%')", parse=T)
   #ggsave("D:/R/Pictures/C5/Node/Iversen_121DefoliationHHFDFD5nodenumber1.png", width=8, height=4, dpi=500)
ggsave("D:/R/Pictures/C5/Yield/Iversen_121DefoliationLLFDFD2yield.png", width=8, height=8, dpi=500)
```
##SS
##F10
```{r,  fig.height=4, fig.width=8}
...
simD4%>%
ggplot(aes(x=Clock.Today,y=Predicted))+geom_line(size=1)+theme_bw()+
  facet_grid(Variable~ID)+ggtitle(paste0("E5ISSFD10","(Iversen_121DefoliationSSFDFD10)"))+
  ...
  #remove grid lines 
   ...
   #annotate("text", x=ymd_hms("2016-07-24 12:00:00"), y=25, size = 5, label ="paste(R_RMSD == 39.7,'%')", parse=T)
   #ggsave("D:/R/Pictures/C5/Node/Iversen_121DefoliationHHFDFD5nodenumber1.png", width=8, height=4, dpi=500)
ggsave("D:/R/Pictures/C5/Yield/Iversen_121DefoliationSSFDFD10yield.png", width=8, height=8, dpi=500)
```
##SS
##F2
```{r,  fig.height=4, fig.width=8}
...
ggplot(aes(x=Clock.Today,y=Predicted))+geom_line(size=1)+theme_bw()+
  ...
  #remove grid lines 
   ...
   #annotate("text", x=ymd_hms("2016-07-24 12:00:00"), y=25, size = 5, label ="paste(R_RMSD == 39.7,'%')", parse=T)
   #ggsave("D:/R/Pictures/C5/Node/Iversen_121DefoliationHHFDFD5nodenumber1.png", width=8, height=4, dpi=500)
ggsave("D:/R/Pictures/C5/Yield/Iversen_121DefoliationSSFDFD2yield.png", width=8, height=8, dpi=500)
```
