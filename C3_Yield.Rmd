...
obsFDSRTLL2%>%
 ...
 geom_point(size=2)+
 theme(legend.title=element_blank(),legend.position = "blank")+xlab("Date")+ylab("DM yield (kg/ha)")+
    #remove grid lines 
  theme(
     panel.spacing=unit(.01, "lines"),
     panel.border = element_rect(colour = "black",size=1), 
...
ggsave("D:/R/Pictures/c6/Yield/E5ILLFD2SR.png", width=5, height=8, dpi=500)
```
...
ggsave("D:/R/Pictures/c6/Yield/E5ILLFD10SR.png", width=5, height=8, dpi=500)
```
###HH
##FD2
```{r,fig.height=5, fig.width=8}
...
ggsave("D:/R/Pictures/c6/Yield/E5IHHFD2SR.png", width=8, height=5, dpi=500)
```
...
ggsave("D:/R/Pictures/c6/Yield/E5IHHFD10SR.png", width=8, height=8, dpi=500)
```
...
ggsave("D:/R/Pictures/c6/Yield/E5ISSFD10SR.png", width=8, height=5, dpi=500)
```
